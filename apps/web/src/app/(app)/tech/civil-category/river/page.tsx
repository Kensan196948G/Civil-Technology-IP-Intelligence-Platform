...
export default async function CivilCategoryRiverPage() {
  const rows = await loadCivilCategoryRows(['river'], '河川');

  return (
    <ListView
      title="土木技術・現場適用 — 河川"
      moduleCode="S-06 / CIVIL TECH CATEGORY"
      description="工種区分「河川」に該当する他社特許・自社技術・NETIS登録技術を横断表示します。"
      rows={rows}
      emptyMessage="工種区分「河川」に該当する技術・特許はまだありません。"
