...
export default async function DependentClaimsPage() {
  ...
  const rows = await db
    ...
    .where(eq(s.patentClaims.isIndependent, false))
  ...
  return (
    <ListView
      ...
      description="取り込み済み他社特許のうち、従属請求項（isIndependent=false）のみを一覧表示します。"
      rows={rows}
      emptyMessage="従属請求項のデータがまだありません。"
